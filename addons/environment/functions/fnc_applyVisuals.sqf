...
// Values: [Brightness, Contrast, Desaturation, TintRGB, HazeColorRGB]
private _visualProfiles = createHashMapFromArray [
...
while {uksfta_environment_enabled} do {
    ...
    private _profile = _visualProfiles getOrDefault [_biome, _visualProfiles get "TEMPERATE"];
